...
Ext.define("climatestation.view.processing.ProcessInputProducts",{
    ...
    requires: [
        'climatestation.view.processing.ProcessInputProductsModel',
        'climatestation.view.processing.ProcessInputProductsController'
    ],
    ...
    initComponent: function () {
        ...
        //            ,autoSync: true
        //            ,requires : [
        //                'climatestation.model.MapSetFinalOutputSubProducts',
        //                'Ext.data.proxy.Rest'
        //            ]
        //            ,proxy: {
        //                type: 'rest',
