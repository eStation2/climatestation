...
Ext.define("climatestation.view.processing.ProcessFinalOutputSubProducts",{
    ...
    requires: [
        'climatestation.view.processing.ProcessFinalOutputSubProductsModel',
        'climatestation.view.processing.ProcessFinalOutputSubProductsController',
    ...
    initComponent: function () {
        ...
        me.columns = [{
            ...
            //            if (rec.get('subactivated')) {
            //                return climatestation.Utils.getTranslation('deactivatesubproduct');   // 'Deactivate SubProduct';
            //            } else {
            //                return climatestation.Utils.getTranslation('activatesubproduct');   // 'Activate SubProduct';
            //            }
            //        },
