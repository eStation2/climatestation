...
Ext.define("climatestation.view.header.Header",{
    ...
    requires: [
        ...
        'climatestation.store.HeaderLogoImages',
        'climatestation.view.header.HeaderController',
        'climatestation.view.header.HeaderModel'
    ],
    ...
    initComponent: function () {
        var me = this;
        var imageTpl = '';
        //me.emptyText = climatestation.Utils.getTranslation('noimagesavailable');  // 'No images available'
        ...
        if (climatestation.globals['typeinstallation'].toLowerCase() == 'jrc_online') {
            imageTpl = new Ext.XTemplate(
                ...
                '        <div id="sub-title">Intra ACP CLimate Station</div>',
