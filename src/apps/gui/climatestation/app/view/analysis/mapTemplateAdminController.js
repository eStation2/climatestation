Ext.define('climatestation.view.analysis.mapTemplateAdminController', {
    ...
    openMapTemplates: function(){
        ...
        for (var i = 0; i < selectedMapTemplates.length; i++) {
            ...
            var newMapViewWin = new climatestation.view.analysis.mapView(mapTemplate);
    ...
    ,deleteMapTemplate: function(grid, rowIndex, row){
        ...
        //Ext.Msg.show({
        //    title: climatestation.Utils.getTranslation('Delete Map Template?'),     // 'Delete layer definition?',
        //    message: climatestation.Utils.getTranslation('Delete Map Template?') + ' "' + record.get('templatename') + '"?',
