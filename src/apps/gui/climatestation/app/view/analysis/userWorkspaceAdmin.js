...
Ext.define("climatestation.view.analysis.userWorkspaceAdmin",{
    extend: "Ext.grid.Panel",

    requires: [
        "Ext.grid.column.Action",
        "climatestation.view.analysis.userWorkspaceAdminController",
        "climatestation.view.analysis.userWorkspaceAdminModel",
    ...
    title: climatestation.Utils.getTranslation('my_saved_workspaces'),
    header: {
        hidden: false,
        titlePosition: 0,
        titleAlign: 'center',
    ...
    initComponent: function () {
        ...
        if(me.refworkspaces){
            if (climatestation.getUser() == 'undefined' || climatestation.getUser() == null){
                me.width = 275;
            }
            else {
                me.width = 420;
        ...
        if(me.refworkspaces){
            me.title = climatestation.Utils.getTranslation('reference_workspaces');
        }
        else {
            me.title = climatestation.Utils.getTranslation('my_saved_workspaces');
        }
            ...
            loadstore: function() {
                if(me.refworkspaces){
                    if (me.forceStoreLoad || !me.getViewModel().getStore('refworkspaces').getSource().isLoaded() || me.dirtyStore) {
                        // me.getViewModel().getStore('refworkspaces').getSource().proxy.extraParams = {userid: climatestation.getUser().userid};
                    ...
                    if (me.forceStoreLoad || !me.getViewModel().getStore('userworkspaces').getSource().isLoaded() || me.dirtyStore) {
                        me.getViewModel().getStore('userworkspaces').getSource().proxy.extraParams = {userid: climatestation.getUser().userid};
        ...
        me.tools = [
        {
            type: 'refresh',
            align: 'c-c',
            tooltip: climatestation.Utils.getTranslation('refreshworkspaceslist'),    // 'Refresh workspaces list',
            callback: function() {
        ...
        me.bbar = Ext.create('Ext.toolbar.Toolbar', {
            ...
            items: [{
                ...
                iconCls: 'far fa-download lightblue',
                // style: {color: 'blue'},
                hidden: me.refworkspaces ? true : false,
                disabled: true,
                // glyph: 'xf055@FontAwesome',
        ...
        me.columns = [{
            text: climatestation.Utils.getTranslation('workspacename'),  // 'Workspace name',
            width: 250,
            ...
            xtype: 'actioncolumn',
            text: climatestation.Utils.getTranslation('open_in_default_ws'),  // 'Open in default WS',
            ...
            groupable: false,
            // hidden: me.refworkspaces ? true : false,
            hidden: (me.refworkspaces && (climatestation.getUser() == 'undefined' || climatestation.getUser() == null) ? true : false),
            items: [{
