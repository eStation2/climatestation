Ext.define('climatestation.view.analysis.timeseriesProductSelectionController', {
    ...
    ,createNewTSDrawPropertiesRecord: function(TSrecord){
        ...
        myNewRecord = new climatestation.model.TSDrawProperties({
            ...
            linestyle: 'Solid',
            linewidth: 2,
            color: climatestation.Utils.convertRGBtoHex('0 0 0'),
            yaxe_id: newyaxes_id
        });
    ...
    ,getTSDrawProperties: function(TSrecord){
        ...
        if (!tsDrawPropertiesStore.isLoaded()){
            ...
            // climatestation.Utils.sleepFor(500);
    ...
    ,editTSDrawProperties: function(gridview, recordID){
        ...
        var source = {
            ...
            color: climatestation.Utils.convertRGBtoHex(gridview.tsdrawprobs_record.get('color'))
        };
        var title = climatestation.Utils.getTranslation('ts_draw_properties_for') + ' '   // 'Time series draw properties for'
        ...
        if (climatestation.Utils.objectExists(myTSDrawPropertiesWin)) {
            ...
            var TSDrawPropertiesWin = new Ext.Window({
                ...
                ,items:[{
                    ...
                    sourceConfig: {
                        yaxe_id: {
                            displayName: climatestation.Utils.getTranslation('yaxes_id'),   // 'Yaxe ID',
                            editor: {}
                            //type: 'text',
                            // editor: {
                            //     xtype: 'textfield',
                        ...
                        tsname_in_legend: {
                            displayName: climatestation.Utils.getTranslation('tsname_in_legend'),   // 'Time series name in legend',
                            //type: 'text',
                            editor: {
                                xtype: 'textfield',
                                selectOnFocus:false
                        ...
                        charttype: {
                            displayName: climatestation.Utils.getTranslation('charttype'),   // 'Chart type',
                            editor: {
                                xtype: 'combobox',
                                store: ['line', 'column'],
                                forceSelection: true
                        ...
                        linestyle: {
                            displayName: climatestation.Utils.getTranslation('linestyle'),   // 'Line style',
                            editor: {
                                xtype: 'combobox',
                                store: ['Solid',
                                        'ShortDash',
                        ...
                        linewidth: {
                            displayName: climatestation.Utils.getTranslation('linewidth'),   // Line width',
                            type: 'number'
                        },
                        color: {
                            displayName: climatestation.Utils.getTranslation('color'),   // 'Colour',
                            editor: {
                                xtype: 'mycolorselector'
                            }
                            ,renderer: climatestation.Utils.colorrenderer
                        }
                    },
                    listeners: {
    ...
    ,getSelectedTSDrawProperties: function(){
        ...
        Ext.util.JSON.decode(me.tplChartView.selectedTimeseries).forEach( function (product){
            var productrecord = new climatestation.model.SelectedTimeseriesMapSetDataSet({
        ...
        if (selectedTimeSeries.length >0){
            if ( Ext.isObject(me.lookupReference('radio_year')) && me.lookupReference('radio_year').getValue()){
                if (me.lookupReference("YearTimeseries").getValue()== null || me.lookupReference("YearTimeseries").getValue() == '') {
                    ...
                    Ext.Msg.show({
                       title: climatestation.Utils.getTranslation('mandatoryfield'),    // 'Mandatory field',
                       msg: climatestation.Utils.getTranslation('pleaseselectayear'),    // 'Please select a year!',
                       width: 300,
                       buttons: Ext.Msg.OK,
                       animEl: '',
                ...
                if (( (ts_from_season == null) && (ts_to_season != null) ) ||
                    ...
                    Ext.Msg.show({
                       title: climatestation.Utils.getTranslation('mandatoryfield'),    // 'Mandatory field',
                       msg: climatestation.Utils.getTranslation('please_give_seasons_date'),    // 'Please give Seasons "From" and "To" date!',
                       width: 300,
                       buttons: Ext.Msg.OK,
                       animEl: '',
                       icon: Ext.Msg.WARNING
                ...
                if (me.lookupReference("ts_from_period").getValue()== null || me.lookupReference("ts_from_period").getValue() == '') {
                    ...
                    Ext.Msg.show({
                       title: climatestation.Utils.getTranslation('mandatoryfield'),    // 'Mandatory field',
                       msg: climatestation.Utils.getTranslation('pleaseselectafromdate'),    // 'Please select a "From date"!',
                       width: 300,
                       buttons: Ext.Msg.OK,
                       animEl: '',
                       icon: Ext.Msg.WARNING
                ...
                if (me.lookupReference("ts_to_period").getValue()== null || me.lookupReference("ts_to_period").getValue() == '') {
                    ...
                    Ext.Msg.show({
                       title: climatestation.Utils.getTranslation('mandatoryfield'),    // 'Mandatory field',
                       msg: climatestation.Utils.getTranslation('pleaseselectatodate'),    // 'Please select a "To date"!',
                       width: 300,
                       buttons: Ext.Msg.OK,
                       animEl: '',
                       icon: Ext.Msg.WARNING
                ...
                if (selectedYears.length < 1){
                    Ext.Msg.show({
                       title: climatestation.Utils.getTranslation('mandatoryfield'),    // 'Mandatory field',
                       msg: climatestation.Utils.getTranslation('please_select_one_or_more_years'),    // 'Please select one or more years!',
                       width: 400,
                       buttons: Ext.Msg.OK,
                       animEl: '',
                       icon: Ext.Msg.WARNING
                ...
                if (me.graphtype == 'ranking' && selectedMultiYears.length < 2){
                    Ext.Msg.show({
                       title: climatestation.Utils.getTranslation('mandatoryfield'),    // 'Mandatory field',
                       msg: climatestation.Utils.getTranslation('please_select_min_two_years'),    // 'Please select more then one year to rank!',
                       width: 400,
                       buttons: Ext.Msg.OK,
                       animEl: '',
                       icon: Ext.Msg.WARNING
                ...
                Ext.Msg.show({
                   title: climatestation.Utils.getTranslation('mandatoryfield'),    // 'Mandatory field',
                   msg: climatestation.Utils.getTranslation('pleaseselectatimeframe'),    // 'Please select a "From date"!',
                   width: 300,
                   buttons: Ext.Msg.OK,
                   animEl: '',
                   icon: Ext.Msg.WARNING
            ...
            Ext.Msg.show({
               title: climatestation.Utils.getTranslation('mandatoryfield'),    // 'Mandatory field',
               msg: climatestation.Utils.getTranslation('pleaseselectatimeseries'),    // 'Please select one or more times series!',
               width: 300,
               buttons: Ext.Msg.OK,
               animEl: '',
               icon: Ext.Msg.WARNING
    ...
    ,TimeseriesProductsGridRowClick: function(grid, recordIdx) {
        ...
        if (me.graphtype == 'xy'){
            ...
            // climatestation.Utils.sleepFor(1200);
            ...
            if (yAxes.length > 4){
                Ext.toast({
                    html: climatestation.Utils.getTranslation('more_than_4_yaxes_message'),    // "You have selected products that will create more than 4 y-Axes in the Profile Graph, which is not supported!<BR><BR>Last selected product is not added.",
                    title: climatestation.Utils.getTranslation('more_than_4_yaxes_title'), // 'Warning! More than 4 Y-axes!'
                    width: 300,
                    align: 't',
                    hideDuration: 1500
                });
        ...
        if (addProduct){
            ...
            if (me.multipleyears || me.year){
                selectedTimeseriesStore.each(function(product) {
                    ...
                    //    yearsData = climatestation.Utils.union_arrays(yearsData, datasetObj.years);
