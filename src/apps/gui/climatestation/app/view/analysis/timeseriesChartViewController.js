Ext.define('climatestation.view.analysis.timeseriesChartViewController', {
    ...
    getGraphSettings: function(){
        ...
        var graphSettings = {
            ...
            userid: climatestation.getUser().userid,
            ...
            disclaimerobjposition: (climatestation.Utils.objectExists(disclaimerObj) && disclaimerObj.rendered) ? disclaimerObj.getPosition(true).toString() : disclaimerObj.disclaimerPosition.toString(),
            disclaimerobjcontent: disclaimerObj.getContent(),
            logosobjposition: (climatestation.Utils.objectExists(logoObj) && logoObj.rendered) ? logoObj.getPosition(true).toString() : logoObj.logoPosition.toString(),
    ...
    setGraphTemplateName: function(){
        ...
        if (me.getView().isNewTemplate){
            ...
            if (climatestation.Utils.objectExists(me.getView().graph_tpl_name) && me.getView().graph_tpl_name !== ''){
                newGraphTemplateName = me.getView().graph_tpl_name + ' - copy';
            }
            else {
                // if (climatestation.Utils.objectExists(me.getView().selectedregionname) && me.getView().selectedregionname != ''){
                //     newGraphTemplateName = newGraphTemplateName + me.getView().selectedregionname;
                //     if (climatestation.Utils.objectExists(me.getView().productversion) && me.getView().productversion != ''){
                //         newGraphTemplateName = newGraphTemplateName + ' - ' + me.getView().productversion;
                //     }
                // }
                if (me.getView().graphtype === 'cumulative'){
                    newGraphTemplateName = climatestation.Utils.getTranslation('CUMULATIVE') + ' - ';
                }
                else if (me.getView().graphtype === 'ranking'){
                    newGraphTemplateName = climatestation.Utils.getTranslation('RANKING_ZSCORE') + ' - ';
                }
            ...
            Ext.MessageBox.prompt(climatestation.Utils.getTranslation('graph_tpl_name'), climatestation.Utils.getTranslation('graph_tpl_save_message') + ':', function(btn, text){   // 'Graph Template Name'   'Please give a unique name for the new graph template'
                if (btn === 'ok'){
        ...
        Ext.Ajax.request({
            ...
            success: function (response, request) {
                ...
                if (responseJSON.success){
                    Ext.toast({hideDuration: 2000, html: responseJSON.message, title: climatestation.Utils.getTranslation('save_graph_tpl'), width: 300, align: 't'});     // "Save Graph template"
                    ...
                    Ext.toast({hideDuration: 2000, html: responseJSON.message, title: climatestation.Utils.getTranslation('error_save_graph_tpl'), width: 300, align: 't'});     // "ERROR saving the Graph template"
                    me.graph_tpl_name = '';
                }
    ...
    getTimeseries: function(callback){
        ...
        var myLoadMask = new Ext.LoadMask({
            msg    : climatestation.Utils.getTranslation('generatingtimeseries'), // 'Generating requested time series...',
        ...
        params = {
            ...
            istemplate : me.isTemplate,
            graph_tpl_id : climatestation.Utils.objectExists(me.graph_tpl_id) ? me.graph_tpl_id : -1,
        ...
        var requestId = Ext.Ajax.request({
            ...
            success: function ( result, request ) {
                myLoadMask.hide();
                if (climatestation.Utils.objectExists(me)){
                    me.timeseriesGraph = Ext.util.JSON.decode(result.responseText);
                    if (climatestation.Utils.objectExists(me.lookupReference('tbar_' + me.id))){
                         me.lookupReference('tbar_' + me.id).enable();
    ...
    setGraphProperties: function() {
        ...
        me.graphProperties.title = climatestation.Utils.objectExists(graphpropertiesRecord.graph_title) && graphpropertiesRecord.graph_title !== '' ? graphpropertiesRecord.graph_title : me.selectedregionname;
        ...
        if (me.yearTS !== '') {
            ...
            if ( (me.tsFromSeason != null && me.tsFromSeason !== "") && (me.tsToSeason != null && me.tsToSeason !== "")){
                if (parseInt(me.tsFromSeason.substring(0, 2)) > parseInt(me.tsToSeason.substring(0, 2))) {
                    me.graphProperties.subtitle = climatestation.Utils.getTranslation('from') + ' ' + me.graphProperties.subtitle + '/' + me.tsFromSeason + '  ' + climatestation.Utils.getTranslation('to') + ' ' + (parseInt(me.graphProperties.subtitle)+1) + '/' + me.tsToSeason;
                }
                else {
                    // me.graphProperties.subtitle = climatestation.Utils.getTranslation('season') + ' ' +  Ext.Date.format(me.tsFromSeason, 'm/d') + ' - ' + Ext.Date.format(me.tsToSeason, 'm/d') + ' ' + climatestation.Utils.getTranslation('of') + ' ' + me.graphProperties.subtitle;
                    me.graphProperties.subtitle = climatestation.Utils.getTranslation('from') + ' ' + me.graphProperties.subtitle + '/' +me.tsFromSeason + '  ' + climatestation.Utils.getTranslation('to') + ' ' + me.graphProperties.subtitle + '/' + me.tsToSeason;
                }
            }
        }
        //else if (Ext.getCmp('radio-compareyears').getValue() && me.yearsToCompare != '') {
            ...
            if (me.yearsToCompare.length === 1){
                ...
                if ( (me.tsFromSeason != null && me.tsFromSeason !== "") && (me.tsToSeason != null && me.tsToSeason !== "")){
                    me.graphProperties.subtitle = climatestation.Utils.getTranslation('from') + ' ' + me.tsFromSeason + '  ' + climatestation.Utils.getTranslation('to') + ' ' +  me.tsToSeason;
                }
            }
        }
        //else if ( Ext.getCmp('radio-fromto').getValue() ){
        else if ( me.tsFromPeriod !== '' && me.tsToPeriod !== ''){
            me.graphProperties.subtitle = climatestation.Utils.getTranslation('from') + ' ' + me.tsFromPeriod + '  ' + climatestation.Utils.getTranslation('to') + ' ' + me.tsToPeriod;
        }
        ...
        graphpropertiesStore.each(function(graphproperties) {   // Should always be 1 record!!
            ...
            me.graphProperties.graph_title_font_color = climatestation.Utils.convertRGBtoHex(graphproperties.get('graph_title_font_color'));

            me.graphProperties.graph_subtitle_font_size = graphproperties.get('graph_subtitle_font_size');
            me.graphProperties.graph_subtitle_font_color = climatestation.Utils.convertRGBtoHex(graphproperties.get('graph_subtitle_font_color'));

            me.graphProperties.xaxe_font_size = graphproperties.get('xaxe_font_size');
            me.graphProperties.xaxe_font_color = climatestation.Utils.convertRGBtoHex(graphproperties.get('xaxe_font_color'));

            me.graphProperties.legend_title_font_size = graphproperties.get('legend_font_size');
            me.graphProperties.legend_title_font_color = climatestation.Utils.convertRGBtoHex(graphproperties.get('legend_font_color'));
    ...
    createDefaultChart: function(mecallback) {
        ...
        if (me.graphtype === 'cumulative' && !me.graphProperties.localRefresh) {
            ...
            me.timeseriesGraph.timeseries.forEach(function (timeserie) {
                //if (timeserie.cumulative) {
                    ...
                    if (timeserie.difference === true) {
                        ...
                        timeserie.name = timeserie.name + ' ('+climatestation.Utils.getTranslation('curr')+')';
                        TimeseriesCumulatedAverages = Ext.clone(timeserie.data);
                    }
                    else if (timeserie.reference === true){
                        refProdName = timeserie.name;
                        timeserie.name = timeserie.name + ' ('+climatestation.Utils.getTranslation('ref')+')';
            ...
            if (TimeseriesCumulatedData != null && TimeseriesCumulatedAverages != null) {
                ...
                aboveAvgColor = climatestation.Utils.convertRGBtoHex(aboveAvgColor);
                var aboveAvg = {
                    data: cumulatedPositive,
                    fillColor: "#ff0000",
                    color: "#ff0000",
                    id: "Above",
                    // name: climatestation.Utils.getTranslation('above') + ' ' + climatestation.Utils.getTranslation('diff'),
                    name: climatestation.Utils.getTranslation('curr') + ' < ' + climatestation.Utils.getTranslation('ref'),
                    type: "area",
                    showInLegend: true,
                ...
                var belowAvg = {
                    ...
                    color: aboveAvgColor,
                    id: "Below",
                    // name: climatestation.Utils.getTranslation('below') + ' ' + climatestation.Utils.getTranslation('diff'),
                    name: climatestation.Utils.getTranslation('curr') + ' > ' + climatestation.Utils.getTranslation('ref'),
                    type: "area",
                    showInLegend: true,
                    enableMouseTracking: false
        ...
        me.timeseriesGraph.timeseries.forEach(function (timeserie) {
            timeserie.color = climatestation.Utils.convertRGBtoHex(timeserie.color);
        });
        ...
        //        }
        //        tscolor = climatestation.Utils.convertRGBtoHex(tscolor);
        //
        //        if (tstype == 'area') {
        ...
        //        //    var rgbarr = [];
        //        //    if (climatestation.Utils.is_array(tscolor)) {
        //        //        rgbarr = tscolor;
        //        //    }
        //        //    else {
        ...
        //        //    var tsG = rgbarr[1];
        //        //    var tsB = rgbarr[2];
        //        //    tscolor = climatestation.Utils.RGBtoHex(tsR, tsG, tsB);
        //        //
        //        //    if (tstype == 'area') {
        //        //        me.timeseriesGraph.timeseries[tscount].fillColor = tscolor;
        //        //    }
        ...
        for (var yaxescount = 0; yaxescount < me.timeseriesGraph.yaxes.length; yaxescount++) {
            ...
            me.timeseriesGraph.yaxes[yaxescount].title_color = climatestation.Utils.convertRGBtoHex(me.timeseriesGraph.yaxes[yaxescount].title_color);

            //if (titlecolor.charAt(0) != "#") { // convert RBG to HEX if RGB value is given. Highcharts excepts only HEX.
            //    var rgb_arr = [];
            //    if (climatestation.Utils.is_array(titlecolor)) {
            //        rgb_arr = titlecolor;
            //    }
            //    else {
            ...
            //    var G = rgb_arr[1];
            //    var B = rgb_arr[2];
            //    titlecolor = climatestation.Utils.RGBtoHex(R, G, B);
        ...
        me.filename = timeseries_names + (me.graphtype === 'xy' ? climatestation.Utils.getTranslation('PROFILE') : me.graphtype)
        if (climatestation.Utils.objectExists(me.graphProperties.title)){
            me.filename += '_' + me.graphProperties.title.replace(' ', '_');
        }
        if (climatestation.Utils.objectExists(me.graphProperties.subtitle)){
        ...
        if (me.graphtype === 'cumulative' && refNullValuesChangedToDiffValue){
            Ext.toast({anchor: me, hideDuration: 4000, html: climatestation.Utils.getTranslation('warning_cumul_values_changed'), title: '', width: 350, align: 't'});
        }
    },
    ...
    createRankingChart: function(mecallback) {
        ...
        me.timeseriesGraph.timeseries.forEach(function (timeserie) {
            timeserie.data.forEach(function (dataItem){
                dataItem.color = climatestation.Utils.convertRGBtoHex(dataItem.color);
            })
            timeserie.color = climatestation.Utils.convertRGBtoHex(timeserie.color);
        });
    ...
    generateChart: function(){
        ...
        if (me.graphtype === 'cumulative'){
            // me.setTitle('<span class="panel-title-style">' + climatestation.Utils.getTranslation('CUMULATIVE')+ ' ' + climatestation.Utils.getTranslation('GRAPH')+ ' - ' + Ext.getCmp('selectedregionname').getValue() +'</span>');
            Ext.fly('graphview_title_' + me.id).dom.innerHTML = climatestation.Utils.getTranslation('CUMULATIVE');
                                                                // + ' ' + climatestation.Utils.getTranslation('GRAPH');
                                                                // me.selectedregionname;
        }
        else if (me.graphtype === 'ranking'){
            // me.setTitle('<span class="panel-title-style">' + climatestation.Utils.getTranslation('RANKING_ZSCORE')+ ' ' + climatestation.Utils.getTranslation('GRAPH')+ ' - ' + Ext.getCmp('selectedregionname').getValue() +'</span>');
            Ext.fly('graphview_title_' + me.id).dom.innerHTML = climatestation.Utils.getTranslation('RANKING_ZSCORE');
                                                                // + ' ' + climatestation.Utils.getTranslation('GRAPH');
                                                                // me.selectedregionname;
        }
        else if (me.graphtype === 'matrix'){
            // me.setTitle('<span class="panel-title-style">' + climatestation.Utils.getTranslation('MATRIX')+ ' ' + climatestation.Utils.getTranslation('GRAPH')+ ' - ' + Ext.getCmp('selectedregionname').getValue() +'</span>');
            Ext.fly('graphview_title_' + me.id).dom.innerHTML = climatestation.Utils.getTranslation('MATRIX');
                                                                // + ' ' + climatestation.Utils.getTranslation('GRAPH');
                                                                // me.selectedregionname;
        }
            ...
            Ext.fly('graphview_title_' + me.id).dom.innerHTML = climatestation.Utils.getTranslation('PROFILE');
                                                                // + ' ' + climatestation.Utils.getTranslation('GRAPH');
                                                                // me.selectedregionname;
        }
        ...
        if (user !== 'undefined' && user != null){
            ...
            storeparams.graph_tpl_id = climatestation.Utils.objectExists(me.graph_tpl_id) ? me.graph_tpl_id : -1;
    ...
    openChartProperties: function() {
        ...
        if (!chartDrawPropertiesPanel) {
            ...
            source = {
                ...
                graph_title: me.graphProperties.title,
                graph_title_font_color: climatestation.Utils.convertRGBtoHex(me.graphProperties.graph_title_font_color),
                graph_title_font_size: me.graphProperties.graph_title_font_size,

                graph_subtitle: me.graphProperties.subtitle,
                graph_subtitle_font_color: climatestation.Utils.convertRGBtoHex(me.graphProperties.graph_subtitle_font_color),
                graph_subtitle_font_size: me.graphProperties.graph_subtitle_font_size,

                legend_font_size: me.graphProperties.legend_title_font_size,
                legend_font_color: climatestation.Utils.convertRGBtoHex(me.graphProperties.legend_title_font_color),

                xaxe_font_size: me.graphProperties.xaxe_font_size,
                xaxe_font_color: climatestation.Utils.convertRGBtoHex(me.graphProperties.xaxe_font_color)
            }
            ...
            source.yaxe1_color = climatestation.Utils.convertRGBtoHex(me.timeseriesGraph.yaxes[0].title_color);
            ...
            if (me.timeseriesGraph.yaxes.length > 1) {
                ...
                source.yaxe2_color = climatestation.Utils.convertRGBtoHex(me.timeseriesGraph.yaxes[1].title_color);
            ...
            if (me.timeseriesGraph.yaxes.length > 2) {
                ...
                source.yaxe3_color = climatestation.Utils.convertRGBtoHex(me.timeseriesGraph.yaxes[2].title_color);
            ...
            if (me.timeseriesGraph.yaxes.length > 3) {
                ...
                source.yaxe4_color = climatestation.Utils.convertRGBtoHex(me.timeseriesGraph.yaxes[3].title_color);
            ...
            chartDrawPropertiesPanel = Ext.create('Ext.panel.Panel', {
                title: climatestation.Utils.getTranslation('graph_properties'),     // 'Graph properties',
                ...
                items: [
                    {
                        text: climatestation.Utils.getTranslation('Chart draw properties'),
                        xtype: 'propertygrid',
                        nameColumnWidth: 180,
                        ...
                        sourceConfig: {
                            // graph_width: {
                            //     displayName: climatestation.Utils.getTranslation('chartwidth'),   // 'graph width (in px)',
                            //     //type: 'number',
                            //     editor: {
                            //         xtype: 'numberfield',
                            //         selectOnFocus:true
                            ...
                            // },
                            // graph_height: {
                            //     displayName: climatestation.Utils.getTranslation('chartheight'),   // 'graph height (in px)',
                            //     //type: 'number',
                            //     editor: {
                            //         xtype: 'numberfield',
                            //         selectOnFocus:true
                            ...
                            // },
                            graph_title: {
                                displayName: climatestation.Utils.getTranslation('title'),   // 'Title',
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            graph_title_font_color: {
                                displayName: climatestation.Utils.getTranslation('titlecolor'),   // 'Title color',
                                editor: {
                            ...
                            graph_title_font_size: {
                                displayName: climatestation.Utils.getTranslation('titlefontsize'),   // 'Title font size',
                                editor: fontsizesCombo
                            },
                            graph_subtitle: {
                                displayName: climatestation.Utils.getTranslation('subtitle'),   // 'Sub title',
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            graph_subtitle_font_color: {
                                displayName: climatestation.Utils.getTranslation('subtitlecolor'),   // 'Sub title color',
                                editor: {
                                    xtype: 'mycolorselector'    // 'mycolorpicker'
                                    //,floating: false
                                }
                            ...
                            graph_subtitle_font_size: {
                                displayName: climatestation.Utils.getTranslation('subtitlefontsize'),   // 'Sub title font size',
                                editor: fontsizesCombo
                            },
                            legend_font_size: {
                                displayName: climatestation.Utils.getTranslation('legendfontsize'),   // 'Legend font size',
                                editor: fontsizesCombo
                            },
                            legend_font_color: {
                                displayName: climatestation.Utils.getTranslation('legendfontcolor'),   // 'Legend font colour',
                                editor: {
                                    xtype: 'mycolorselector'    // 'mycolorpicker'
                                }
                                , renderer: crenderer
                            ...
                            xaxe_font_size: {
                                displayName: climatestation.Utils.getTranslation('xaxefontsize'),   // 'xAxe font size',
                                editor: fontsizesCombo
                            },
                            xaxe_font_color: {
                                displayName: climatestation.Utils.getTranslation('xaxefontcolor'),   // 'xAxe font color',
                                editor: {
                                    xtype: 'mycolorselector'    // 'mycolorpicker'
                                }
                                , renderer: crenderer
                            ...
                            yaxe1_id: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('id')
                                //type: null
                                //editor: null,
                                //editable: false,
                                //disabled: true,
                            ...
                            yaxe1_title: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('title'),
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe1_font_size: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('fontsize'),
                                editor: fontsizesCombo
                            },
                            yaxe1_color: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('color'),
                                editor: {
                                    xtype: 'mycolorselector'    // 'mycolorpicker'
                                }
                                , renderer: crenderer
                            ...
                            yaxe1_min: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('min'),
                                editor: {
                                    xtype: 'numberfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe1_max: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('max'),
                                editor: {
                                    xtype: 'numberfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe1_opposite: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('opposite'),   // 'Opposite',
                                type: 'boolean'
                            },
                            yaxe1_unit: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('unit'),   // 'Unit',
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe1_aggregation_type: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('aggregation_type'),   // 'Aggregation type',
                                editor: {
                                    xtype: 'combobox',
                            ...
                            yaxe1_aggregation_min: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('aggregation_min'),   // 'Aggregation min',
                                type: 'number'
                            },
                            yaxe1_aggregation_max: {
                                displayName: 'yAxe 1 ' + climatestation.Utils.getTranslation('aggregation_max'),   // 'Aggregation max',
                                type: 'number'
                            },


                            yaxe2_id: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('id'),
                                editor: {}
                            },
                            yaxe2_title: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('title'),
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe2_font_size: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('fontsize'),
                                editor: fontsizesCombo
                            },
                            yaxe2_color: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('color'),
                                editor: {
                                    xtype: 'mycolorselector'    // 'mycolorpicker'
                                }
                                , renderer: crenderer
                            ...
                            yaxe2_min: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('min'),
                                editor: {
                                    xtype: 'numberfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe2_max: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('max'),
                                editor: {
                                    xtype: 'numberfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe2_opposite: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('opposite'),   // 'Opposite',
                                type: 'boolean'
                            },
                            yaxe2_unit: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('unit'),   // 'Unit',
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe2_aggregation_type: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('aggregation_type'),   // 'Aggregation type',
                                editor: {
                                    xtype: 'combobox',
                            ...
                            yaxe2_aggregation_min: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('aggregation_min'),   // 'Aggregation min',
                                type: 'number'
                            },
                            yaxe2_aggregation_max: {
                                displayName: 'yAxe 2 ' + climatestation.Utils.getTranslation('aggregation_max'),   // 'Aggregation max',
                                type: 'number'
                            },


                            yaxe3_id: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('id'),
                                editor: {}
                            },
                            yaxe3_title: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('title'),
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe3_font_size: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('fontsize'),
                                editor: fontsizesCombo
                            },
                            yaxe3_color: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('color'),
                                editor: {
                                    xtype: 'mycolorselector'    // 'mycolorpicker'
                                }
                                , renderer: crenderer
                            ...
                            yaxe3_min: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('min'),
                                editor: {
                                    xtype: 'numberfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe3_max: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('max'),
                                editor: {
                                    xtype: 'numberfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe3_opposite: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('opposite'),   // 'Opposite',
                                type: 'boolean'
                            },
                            yaxe3_unit: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('unit'),   // 'Unit',
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe3_aggregation_type: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('aggregation_type'),   // 'Aggregation type',
                                editor: {
                                    xtype: 'combobox',
                            ...
                            yaxe3_aggregation_min: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('aggregation_min'),   // 'Aggregation min',
                                type: 'number'
                            },
                            yaxe3_aggregation_max: {
                                displayName: 'yAxe 3 ' + climatestation.Utils.getTranslation('aggregation_max'),   // 'Aggregation max',
                                type: 'number'
                            },


                            yaxe4_id: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('id'),
                                editor: {}
                            },
                            yaxe4_title: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('title'),
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe4_font_size: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('fontsize'),
                                editor: fontsizesCombo
                            },
                            yaxe4_color: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('color'),
                                editor: {
                                    xtype: 'mycolorselector'    // 'mycolorpicker'
                                }
                                , renderer: crenderer
                            ...
                            yaxe4_min: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('min'),
                                //type: 'number',
                                editor: {
                                    xtype: 'numberfield',
                                    selectOnFocus: true
                            ...
                            yaxe4_max: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('max'),
                                editor: {
                                    xtype: 'numberfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe4_opposite: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('opposite'),   // 'Opposite',
                                type: 'boolean'
                            },
                            yaxe4_unit: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('unit'),   // 'Unit',
                                editor: {
                                    xtype: 'textfield',
                                    selectOnFocus: true
                                }
                            ...
                            yaxe4_aggregation_type: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('aggregation_type'),   // 'Aggregation type',
                                editor: {
                                    xtype: 'combobox',
                            ...
                            yaxe4_aggregation_min: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('aggregation_min'),   // 'Aggregation min',
                                type: 'number'
                            },
                            yaxe4_aggregation_max: {
                                displayName: 'yAxe 4 ' + climatestation.Utils.getTranslation('aggregation_max'),   // 'Aggregation max',
                                type: 'number'
                            }
                        },
