Ext.define("climatestation.view.analysis.mapView",{
    ...
    requires: [
        ...
        'climatestation.view.analysis.mapLegendObject',
        'climatestation.view.analysis.mapScaleLineObject',
        'climatestation.view.analysis.mapTitleObject',
        'climatestation.view.analysis.mapViewController',
        'climatestation.view.analysis.mapViewModel',
        'climatestation.view.widgets.TimeLine'
    ],
    ...
    initComponent: function () {
        ...
        me.tools = [{
            type: 'gear',
            tooltip: climatestation.Utils.getTranslation('maptoolsmenu'), // 'Map tools menu',
            ...
            items: [{
                ...
                listeners: {
                    ...
                    afterrender: function (btn) {
                        ...
                        Ext.tip.QuickTipManager.register({
                            ...
                            title: '',
                            text: climatestation.Utils.getTranslation('zoom_factor')
                        });
                ...
                menu: {
                    ...
                    items: [{
                        ...
                        fieldLabel: '<b>'+climatestation.Utils.getTranslation('zoom_factor')+'</b>',
                        labelAlign: 'top',
                        hideLabel: false,
                        hideOnClick: false,
                        width: 180,
                ...
                listeners: {
                    afterrender: function (btn) {
                        ...
                        Ext.tip.QuickTipManager.register({
                            target: btn.getId(), // Target button's ID
                            title: '',
                            text: climatestation.Utils.getTranslation('opacity_slider')  // 'Product layer opacity slider'
                        });
                            ...
                            listeners: {
                                afterrender: function (me) {
                                    ...
                                    Ext.tip.QuickTipManager.register({
                                        ...
                                        title: '',
                                        text: climatestation.Utils.getTranslation('interval_in_ms') // 'Interval in milliseconds'
                                    });
                                }
                            }
                        }]
        ...
        me.listeners = {
            ...
            ,afterrender: function () {
                ...
                me.map.on('dblclick', function(evt) {
                    ...
                    //if (!drawgeometry_togglebtn.pressed && me.map.getLayers().getArray().length > 2) {
                    if (!drawgeometry_togglebtn.pressed) {
                        if (climatestation.Utils.objectExists(me.selectedfeature)) {
                ...
                me.mon(me.el, {
                    mouseout: function() {
                        //console.info(me);
                        if (climatestation.Utils.objectExists(me.featureOverlay) && climatestation.Utils.objectExists(me.highlight)){
                ...
                if (!me.nozoom){
                    if (climatestation.Utils.objectExists(me.zoomextent) && me.zoomextent != null && me.zoomextent.trim() != ''){
                ...
                var mapviewtimeline = me.lookupReference('product-time-line_' + me.id);
                if (climatestation.Utils.objectExists(me.productcode) && me.productcode != ''){
                ...
                if (climatestation.Utils.objectExists(me.mapviewSize)){
                ...
                if (climatestation.Utils.objectExists(me.disclaimerObjPosition)){
                ...
                if (climatestation.Utils.objectExists(me.productcode) && me.productcode != ''){
                    ...
                    //         if (climatestation.Utils.objectExists(rec.get('productmapsets'))) {
                    ...
                    if (climatestation.Utils.objectExists(productRec)) {
                        ...
                        if (climatestation.Utils.objectExists(productRec.get('productmapsets'))) {
                ...
                if (me.outmask && climatestation.Utils.objectExists(me.outmaskFeature) && me.outmaskFeature != '' ){
