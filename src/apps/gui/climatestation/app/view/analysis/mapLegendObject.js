...
Ext.define("climatestation.view.analysis.mapLegendObject",{
    extend: "Ext.container.Container",  // "Ext.panel.Panel",

    requires: [
        "climatestation.view.analysis.mapLegendObjectController",
        "climatestation.view.analysis.mapLegendObjectModel",
        ...
        me.listeners = {
            ...
            afterrender: function () {
                Ext.tip.QuickTipManager.register({
                    target: this.id,
                    trackMouse: true,
                    title: climatestation.Utils.getTranslation('legend_object'), // 'Legend object',
                    text: climatestation.Utils.getTranslation('doubleclick_to_change_view') // 'Double click to change view.'
                });
