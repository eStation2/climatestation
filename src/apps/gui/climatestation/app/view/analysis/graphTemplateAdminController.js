Ext.define('climatestation.view.analysis.graphTemplateAdminController', {
    ...
    openGraphTemplates: function(){
        ...
        for (var i = 0; i < selectedGraphTemplates.length; i++) {
           // console.info(selectedGraphTemplates[i]);
            ...
            var newGraphViewWin = new climatestation.view.analysis.timeseriesChartView(graphTemplate);
