Ext.define('climatestation.view.analysis.ProductNavigatorController', {
    ...
    assignLegend: function(){
        ...
        var newAssignLegendWin = new climatestation.view.analysis.legendAdmin({
            assign: true,
        ...
        //         ,closable: true
        //         ,loadMask: true
        //         ,title: climatestation.Utils.getTranslation('assign_legends_to') + ' ' + productname + '<b class="smalltext"> - ' + productversion + '</b>'  // 'Assign legends to <productname>'
        //         ,closeAction:'destroy'
        //         ,modal: true
    ...
    mapsetItemClick: function(dataview, record ){
        ...
        // colorschemesgrid.columns[1].setText('<div class="grid-header-style">'+climatestation.Utils.getTranslation('colorschemes')+'</div>');
        ...
        mapsetdatasetgrid.columns[0].setText('<div class="grid-header-style">' + climatestation.Utils.getTranslation('datasets') + ' <b class="smalltext">' + climatestation.Utils.getTranslation('formapset') + ' ' + record.get('descriptive_name') + '</b></div>');
    ...
    mapsetDataSetGridRowClick: function(gridview, record, tr, rowIndex, e, eOpts) { // for rowclick
        ...
        // colorschemesgrid.columns[1].setText('<div class="grid-header-style">' + climatestation.Utils.getTranslation('colorschemes') +
