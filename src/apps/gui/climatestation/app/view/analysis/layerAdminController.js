Ext.define('climatestation.view.analysis.layerAdminController', {
    ...
    ,addLayer: function(){
        ...
        var layersgridstore  = Ext.data.StoreManager.lookup('LayersStore');
        var newLayerRecord = new climatestation.model.Layer(
            {
                'layerid': 'newlayer',
                'layerlevel': '',
                'layername': 'New layer',
        ...
        var addLayerWin = new climatestation.view.analysis.addEditLayer({
            params: {
                edit: false,
    ...
    ,deleteLayer: function(grid, rowIndex, row){
        ...
        if (record.get('deletable')){
            Ext.Msg.show({
                title: climatestation.Utils.getTranslation('deletelayerquestion'),     // 'Delete layer definition?',
                message: climatestation.Utils.getTranslation('deletelayerquestion2') + ' "' + record.get('layername') + '"?',
