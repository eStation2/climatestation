Ext.define('climatestation.view.analysis.addEditLayerController', {
    ...
    ,saveLayerInfo: function(){
        ...
        if (form.isValid()) {
            ...
            //    Ext.getCmp('layeradministration').toFront();
                Ext.toast({html: climatestation.Utils.getTranslation('layer_settings_saved'), title: climatestation.Utils.getTranslation('saved'), width: 200, align: 't'});
    ...
    ,selectLayer: function(){
        ...
        var gp = new Ext.grid.Panel({
            ...
            columns: [{
                text: climatestation.Utils.getTranslation('layerfile'),   // "Layer file name",
                width: 400,
                sortable: false,
                hideable: false,
                ...
                text: climatestation.Utils.getTranslation('filesize'),   // "File size",
                width: 200,
                sortable: false,
                hideable: false,
                variableRowHeight: true,
            ...
            buttons: [{
                text: climatestation.Utils.getTranslation('selectlayer'), // 'Select',
                handler: function(){
                    if (gp.getSelectionModel().selected.items.length == 1){
                        ...
                        Ext.toast({html: climatestation.Utils.getTranslation('pleaseselectlayerfile'), title: climatestation.Utils.getTranslation('warning'), width: 200, align: 't'});
                    }
                }
            },{
        ...
        var selectLayerFileWin = new Ext.Window({
            ...
            ,closable:true
            ,loadMask:true
            ,title:climatestation.Utils.getTranslation('selectlayerfile') // 'Select a layer file present on the server.'
            ,items:gp
        });
    ...
    ,importLayer:function() {
        ...
        var fileUploadWin = new Ext.Window({
            ...
            ,closable:true
            ,loadMask:true
            ,title:climatestation.Utils.getTranslation('importlayer') // 'Import layer'
            ,items:[{
                xtype: 'form',
                fileUpload: true,
                width: 400,
                ...
                items: [{
                    ...
                    ,id: 'layerfile'
                    ,name: 'layerfile'
                    ,emptyText: climatestation.Utils.getTranslation('select_geojson file') // 'Select a .geojson file'
                    //,fieldLabel: climatestation.Utils.getTranslation('import_layer_geojson_file') // 'Layer .geojson file'
                    ,width: 200
                    ,vtype:'GeoJSON'
                    //,labelWidth: 150
                    ,msgTarget: 'side'
                    ...
                    handler: function(){
                        if(this.up().up().getForm().isValid()){
                            ...
                            this.up().up().getForm().submit({
                                url:'layers/import',
                                //scope:this,
                                waitMsg: climatestation.Utils.getTranslation('msg_wait_importing_layer'), // 'Importing layer...',
                                success: function(fp, o, x){
                                    var tpl = new Ext.XTemplate(
                                        climatestation.Utils.getTranslation('layer_file_saved_on_the_server')+'<br />',
                            ...
                            Ext.Msg.alert(climatestation.Utils.getTranslation('warning'), climatestation.Utils.getTranslation('vtype_geojson'));
                        }
                    }
                },{
    ...
    //    console.info(view);
        ...
        if (!climatestation.Utils.objectExists(view.tip)){
...
//                     "->",
//                     {
//                         text:climatestation.Utils.getTranslation('btn_txt_start_upload') // 'Start Upload'
//                         ,id:'btn-startupload'
//                         ,disabled:true
...
//                         }
//                     },{
//                         text:climatestation.Utils.getTranslation('btn_txt_abort') // 'Abort'
//                         ,id:'btn-abort'
//                         ,disabled:true
...
//                                 Ext.Msg.alert('',climatestation.Utils.getTranslation('Msg_txt_select_upload_to_cancel')); // 'Please select an upload to cancel'
//                                 return true;
//                             }
...
//                         }
//                     },{
//                         text:climatestation.Utils.getTranslation('btn_txt_abort_all') // 'Abort All'
//                         ,id:'btn-abortall'
//                         ,disabled:true
//                         ,icon:'resources/img/cancel.png'
//                         ,scope:this
...
//                         }
//                     },{
//                         text:climatestation.Utils.getTranslation('btn_txt_remove') // 'Remove'
//                         ,id:'btn-remove'
//                         ,disabled:true
...
//                         }
//                     },{
//                         text:climatestation.Utils.getTranslation('btn_txt_remove_all') // 'Remove All'
//                         ,id:'btn-removeall'
//                         ,disabled:true
//                         ,icon:'resources/img/cross.png'
//                         ,scope:this
...
//                            items: [{
//                                id:'btn-useforlayer',
//                                text: climatestation.Utils.getTranslation('btn_txt_useforlayer'), // 'Use for layer',
//                                disabled:true,
//                                scope:this,
//                                handler:function(){
...
//                 }
//        			,columns:[
//        				 {header:climatestation.Utils.getTranslation('gridcolheader_filename'),dataIndex:'name', width:200} // 'File Name'
//        				,{header:climatestation.Utils.getTranslation('gridcolheader_size'),dataIndex:'size', width:60, renderer:Ext.util.Format.fileSize} // 'Size'
//        				,{header:'&nbsp;',dataIndex:'status', width:30, renderer:statusIconRenderer}
//        				,{header: climatestation.Utils.getTranslation('gridcolheader_status'),dataIndex:'status', width:60} // 'Status'
//        				,{header:climatestation.Utils.getTranslation('gridcolheader_progress'),dataIndex:'progress', width:130, renderer:progressBarColumnRenderer} // 'Progress'
//        			]
// //               },{
// //                xtype:'box'
...
//        		title:climatestation.Utils.getTranslation('title_multiple_file_upload_win') // 'Upload layer file(s)'
//        		,closeAction:'close'
//        		,frame:true
//             ,layout:'fit'
//             ,modal: true
