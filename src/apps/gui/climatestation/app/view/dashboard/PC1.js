...
Ext.define("climatestation.view.dashboard.PC1",{
    ...
    requires: [
        ...
        'climatestation.view.dashboard.PC1Controller',
        'climatestation.view.dashboard.PC1Model'
    ],

    name:'dashboardpc1',
    id: 'dashboardpc1',

    title: '<span class="panel-title-style">' + climatestation.Utils.getTranslation('receivingstation') + '</span>',
    disabled:false,
    ...
    initComponent: function () {
        var me = this;
        me.title = '<span class="panel-title-style">' + climatestation.Utils.getTranslation('receivingstation') + '</span>';
        me.bodyPadding = 0;
