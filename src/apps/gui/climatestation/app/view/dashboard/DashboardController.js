Ext.define('climatestation.view.dashboard.DashboardController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.dashboard-dashboard',

    requires: [
        'climatestation.Utils',
        'climatestation.view.dashboard.Connection',
        'climatestation.view.dashboard.PC1',
        ...
        this.getStore('dashboard').load({
            callback: function(records, options, success){
                ...
                if (me.type_installation === 'full'){
                    ...
                    me.PC2_modeText = climatestation.Utils.getTranslation(me.PC2_mode);
                    me.PC3_modeText = climatestation.Utils.getTranslation(me.PC3_mode);
                    ...
                    PC2 = {
                        ...
                        name:'dashboardpc2',
                        id: 'dashboardpc2',
                        paneltitle: climatestation.Utils.getTranslation('processing_pc2'),
                    ...
                    PC3 = {
                        ...
                        name:'dashboardpc3',
                        id: 'dashboardpc3',
                        paneltitle: climatestation.Utils.getTranslation('processing_pc3'),
                    ...
                    PC2 = {
                        ...
                        name:'dashboardpc2',
                        id: 'dashboardpc2',
                        paneltitle: climatestation.Utils.getTranslation('processing_analysis_pc2'),
                        setdisabledPartial:pc2DisabledPartial,
                        setdisabledAll:pc2DisabledAll,
                        activePC:pc2Active,
                        activeversion: me.PC2_version,
