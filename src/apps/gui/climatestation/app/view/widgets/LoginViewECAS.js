...
Ext.define("climatestation.view.widgets.LoginViewECAS",{
    extend: "Ext.container.Container",

    requires: [
        "climatestation.view.widgets.LoginViewECASController",
        "climatestation.view.widgets.LoginViewECASModel",
    ...
    ,initComponent: function () {
        ...
        me.listeners = {
            beforerender: function(){
                ...
                if (climatestation.Utils.objectExists(params.ticket) && params.ticket != '' && climatestation.Utils.objectExists(params.strCall && params.strCall != '')){
        ...
        if (user != null && user != 'undefined'){
            ...
            if (analysisWorkspaces != []) {
                Ext.Object.each(analysisWorkspaces, function (id, workspace, thisObj) {
                    ...
                    if (climatestation.globals['typeinstallation'] != 'jrc_online') {
