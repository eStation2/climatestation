Ext.define('climatestation.view.datamanagement.requestsAdminController', {
    ...
    runPauseRequest: function(grid, rowIndex, row){
        ...
        if (origstatus=='running'){
            ...
            msg = climatestation.Utils.getTranslation('pausing_request') + ' ' + record.get('requestid');
        }
            ...
            msg = climatestation.Utils.getTranslation('restarting_request') + ' ' + record.get('requestid');
        }
                    ...
                    if (request.success) {
                        ...
                        if (origstatus == 'running') {
                            ...
                            if (request.status.toLowerCase() == 'error') {
                                ...
                                Ext.Msg.show({
                                    title: climatestation.Utils.getTranslation('error_pausing_request'),
                            ...
                            if (request.status.toLowerCase() == 'error') {
                                ...
                                Ext.Msg.show({
                                    title: climatestation.Utils.getTranslation('error_restarting_request'),
                                    message: request.message,
                                    buttons: Ext.Msg.OK,
                                    icon: Ext.Msg.WARNING,
                                    fn: function (btn) {
    ...
    ,deleteRequest: function(grid, rowIndex, row){
        ...
        var msg = climatestation.Utils.getTranslation('deleting_request') + ' ' + record.get('requestid');
            ...
            callback:function(callinfo,responseOK,response ){
                ...
                if (Ext.isObject(request)) {
                    if (request.success) {
                        ...
                        Ext.Msg.show({
                            title: climatestation.Utils.getTranslation('error_deleting_request'),
                            message: request.message,
                            buttons: Ext.Msg.OK,
                            icon: Ext.Msg.WARNING,
                            fn: function (btn) {
