Ext.define('climatestation.view.datamanagement.sendRequestController', {
    ...
    getRequest: function() {
        ...
        Ext.Ajax.request({
            ...
            params: params,
            // loadMask: climatestation.Utils.getTranslation('loading'),    // 'Loading...',
            ...
            success: function ( result, request ) {
                ...
                var requestHTML = '<h3><b style="word-wrap: break-word;">' + climatestation.Utils.getTranslation('missingdatafor') + ':</b></h3>';     // generate_request_text
                requestHTML = requestHTML + '<table><tr><td><b>' + climatestation.Utils.getTranslation('productcode') + ': </b></td><td><b>' + request.product + '</b></td></tr><tr><td><b>' + climatestation.Utils.getTranslation('version') + ': </b></td><td><b>' + request.version + '</b></td></tr></table>';
                requestHTML = requestHTML + '<table id="gradient-style" width="100%"><thead><tr><th scope="col">' + climatestation.Utils.getTranslation('mapset') + '</th><th scope="col">' + climatestation.Utils.getTranslation('subproduct') + '</th></tr></thead><tbody>';
                for (var mapsetrec in request.productmapsets) {
                    ...
                    for (var dataset in request.productmapsets[mapsetrec].mapsetdatasets) {
                        var missingfiles = climatestation.Utils.getTranslation('missingfiles') + ': ' + request.productmapsets[mapsetrec].mapsetdatasets[dataset].missingfiles.length;
    ...
    ,createRequestJob: function () {
        ...
        var myMask = new Ext.LoadMask({
            msg    : climatestation.Utils.getTranslation('creating_requestjob'),
