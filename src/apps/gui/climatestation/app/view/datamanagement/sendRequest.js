Ext.define("climatestation.view.datamanagement.sendRequest", {
    ...
    requires: [
        ...
        'climatestation.view.datamanagement.sendRequestController',
        'climatestation.view.datamanagement.sendRequestModel'
    ],

    title: climatestation.Utils.getTranslation('getrequestfile'),     // 'Send request',
    header: {
        titlePosition: 0,
        titleAlign: 'center'
    },
    ...
    initComponent: function () {
        ...
        me.items = [{
            ...
            items: [{
                xtype: 'combobox',
                fieldLabel: climatestation.Utils.getTranslation('get_data_for_dekad_products'),    // 'Years back for dekad products',
                // labelAlign: 'top',
                ...
                xtype: 'combobox',
                fieldLabel: climatestation.Utils.getTranslation('get_data_for_daily_products'),    // 'Years back for daily products',
                // labelAlign: 'top',
                ...
                items: [{
                    ...
                    queryMode: 'local',
                    msgTarget: 'side',
                    emptyText: climatestation.Utils.getTranslation('selectadays')    // 'Select days...'
                }, {
                    xtype: 'button',
                    text: climatestation.Utils.getTranslation('apply'),    //'Apply',
                    scale: 'medium',
                    disabled: false,
                    // width: 120,
                    margin: '0 0 5 50',
