...
Ext.define("climatestation.view.system.IPAddressAdmin",{
    ...
    requires: [
        ...
        'climatestation.view.system.IPAddressAdminController',
        'climatestation.view.system.IPAddressAdminModel'
    ],

    title: climatestation.Utils.getTranslation('ipaddressadmin'),    // 'IP address administration',
    header: {
        titlePosition: 0,
        titleAlign: 'center'
    },
        ...
        me.items = [{
            ...
            items:[{
                ...
                items:[{
                    ...
                    xtype: 'textfield',
                    fieldLabel: climatestation.Utils.getTranslation('ipaddresspc1'),    // 'IP address PC1',
                    ...
                    xtype: 'textfield',
                    fieldLabel: climatestation.Utils.getTranslation('ipaddresspc2'),    // 'IP address PC2',
                    //style:'font-weight: bold;',
                    allowBlank: false,
                    vtype:'IPAddress'
                },{
                    ...
                    xtype: 'textfield',
                    fieldLabel: climatestation.Utils.getTranslation('ipaddresspc3'),    // 'IP address PC3',
                    //style:'font-weight: bold;',
                    allowBlank: false,
                    vtype:'IPAddress'
                },{
                    ...
                    xtype: 'textfield',
                    fieldLabel: climatestation.Utils.getTranslation('dnsipaddress'),    // 'DNS IP address',
                    //style:'font-weight: bold;',
                    allowBlank: false,
                    vtype:'IPAddress'
                },{
                    ...
                    xtype: 'textfield',
                    fieldLabel: climatestation.Utils.getTranslation('gatewayipaddress'),    // 'Gateway IP address',
                    //style:'font-weight: bold;',
                    allowBlank: false,
                    vtype:'IPAddress'
                },{
                    ...
                    xtype: 'textfield',
                    fieldLabel: climatestation.Utils.getTranslation('lanaccessipaddress'),    // 'LAN Access IP address<br>(like 192.168.0.0/24)',
                    //style:'font-weight: bold;',
                    allowBlank: false,
                    vtype:'IPNetmask'
                }]
