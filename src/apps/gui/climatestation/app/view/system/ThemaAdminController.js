Ext.define('climatestation.view.system.ThemaAdminController', {
            ...
            callback: function(records, options, success){
                records.forEach(function(record) {
                    ...
                    if (thema_id == me.params.currentthema){
                        fieldlabel = climatestation.Utils.getTranslation('activethema');    // 'Active thema';
                        checked = true;
                    }
                    themaradio = {
            ...
            success: function(response, opts){
                ...
                if (result.success){
                    if (climatestation.globals['typeinstallation'] === 'windows'){
                        Ext.toast({ html: climatestation.Utils.getTranslation('systemthemasetto') + " " + newthema.thema,
                                    title: climatestation.Utils.getTranslation('themachanged'),
                                    width: 300, align: 't' });
                    }
                    else {
                        Ext.toast({ html: climatestation.Utils.getTranslation('systemthemasetto') + " " + newthema.thema + "</BR>" + result.message,
                                    title: climatestation.Utils.getTranslation('themachanged'),
                                    width: 300, align: 't' });
                    }
                }
