Ext.define('climatestation.view.system.PCModeAdminController', {
    ...
    changeMode: function() {
        ...
        if (permitChangeMode){
            ...
            Ext.Msg.alert('Mode can NOT be changed!',
                'You cannot change to ' + climatestation.Utils.getTranslation(newmode) + ' while the other PC is in ' + climatestation.Utils.getTranslation(otherPCMode) + '!');
        }
    ...
    setMode: function(newmode, waitForFullSync) {
        ...
        Ext.Ajax.request({
            ...
            success: function(response, opts){
                ...
                if (result.success){
                    Ext.Msg.alert(climatestation.Utils.getTranslation('modechanged'), result.message);
                    //Ext.toast({ html: climatestation.Utils.getTranslation('systemmodesetto') + " " + newmode,
                    //            title: climatestation.Utils.getTranslation('modechanged'),
                    //            width: 200, align: 't' });
