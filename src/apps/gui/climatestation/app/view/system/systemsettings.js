            ...
            items: ['->', {
                ...
                handler: function () {
                    ...
                    var systemsettingsrecord = systemsettingsstore.getModel().load(0, {
                        ...
                        success: function(record, operation) {
                            // console.info(me.formpanel);
                            if (operation.success){
                                me.formpanel.loadRecord(systemsettingsrecord);
                                me.formpanel.updateRecord();
        ...
        me.formbbar = {
            ...
            items: [{
               ...
               text: climatestation.Utils.getTranslation('resettofactorysettings'), // 'Reset to factory settings',
                ...
                scope: me,
                iconCls: 'far fa-save white',    // 'icon-disk',
                ...
                handler: function () {
                    ...
                    if (SystemSettingChanges != null) {
                        ...
                        Ext.toast({
                            html: climatestation.Utils.getTranslation('systemsettingssaved'),
                            title: climatestation.Utils.getTranslation('systemsettingssaved'),
                            width: 200,
                            align: 't'
                        });
