Ext.define('climatestation.view.system.PCLogLevelAdminController', {
            ...
            callback: function(records, options, success){
                records.forEach(function(record) {
                    ...
                    if (loglevel == me.params.currentloglevel){
                        fieldlabel =  climatestation.Utils.getTranslation('activeloglevel'); // 'Active log level';
                        checked = true;
                    }
                    loglevelradio = {
    ...
    ,changeLogLevel: function() {
        ...
        Ext.Ajax.request({
            ...
            success: function(response, opts){
                ...
                if (result.success){
                    Ext.toast({ html: climatestation.Utils.getTranslation('systemloglevelsetto') + " " + newloglevel.loglevel,
                                title: climatestation.Utils.getTranslation('loglevelchanged'),
                                width: 200, align: 't' });
                }
