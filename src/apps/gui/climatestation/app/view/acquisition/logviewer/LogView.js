...
Ext.define("climatestation.view.acquisition.logviewer.LogView",{
    ...
    requires: [
        ...
        'climatestation.view.acquisition.logviewer.LogViewController',
        'climatestation.view.acquisition.logviewer.LogViewModel'
    ],

    title: climatestation.Utils.getTranslation('logviewer'),     // 'Log viewer',
    header: {
        titlePosition: 0,
        titleAlign: 'center'
    },
    ...
    initComponent: function () {
        ...
        me.title = climatestation.Utils.getTranslation('logviewer');     // 'Log viewer',

        me.tbar = ['  ',
            {
                xtype: 'textfield',
                id:'highlightfindstring', // + me.logtype + me.params.record.get('productid'),
                fieldLabel: climatestation.Utils.getTranslation('search'),    // 'Search',
                labelWidth: 60,
                labelAlign: 'left',
                labelStyle: 'font-weight:bold;',
                hidden:false,
                qtip: climatestation.Utils.getTranslation('tiplogviewsearch'),    // 'Search and highlight in current file.',
                width:250
//                scope:this
//                listeners: {
