...
Ext.define("climatestation.view.acquisition.selectMapsetForIngest",{
    ...
    requires: [
        ...
        'climatestation.view.acquisition.selectMapsetForIngestController',
        'climatestation.view.acquisition.selectMapsetForIngestModel'
    ],
    ...
    initComponent: function () {
        ...
        me.title = '<div class="panel-title-style-16">' + climatestation.Utils.getTranslation('selectmapset') + '</div>';
        ...
        me.items = [{
            ...
            items: Ext.create('Ext.view.View', {
                ...
                emptyText: climatestation.Utils.getTranslation('nomapsets'),    // 'No mapsets to display. Please select a product to view its mapsets',
                scrollable: true,
                listeners: {
