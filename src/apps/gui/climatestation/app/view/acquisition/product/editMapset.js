...
Ext.define("climatestation.view.acquisition.product.editMapset",{
    ...
    requires: [
        ...
        'climatestation.store.BboxStore',
        'climatestation.store.DefinedByStore',
        'climatestation.store.ProjectionsStore',
        'climatestation.store.ResolutionsStore',
        'climatestation.view.acquisition.product.editMapsetController',
        'climatestation.view.acquisition.product.editMapsetModel'
    ],
    xtype: 'editmapset',

    title: climatestation.Utils.getTranslation('editmapset'),
    header: {
        titlePosition: 0,
        titleAlign: 'center'
    },
    ...
    initComponent: function () {
        ...
        me.items = [{
            ...
            items: [{
                ...
                // }, {
                //     xtype: 'textareafield',
                //     fieldLabel: climatestation.Utils.getTranslation('coordinatesystem'),    // 'Coordinate System',
                //     labelAlign: 'top',
                //     reference: 'srs_wkt',
                //     allowBlank: false,
                ...
                //     style: 'background: white;'
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            xtype: 'displayfield',
                            fieldLabel: climatestation.Utils.getTranslation('pixel_size_long'),
                            labelAlign: 'top',
                            ...
                            xtype: 'checkboxfield',
                            boxLabel: climatestation.Utils.getTranslation('center_of_pixel'),
                            labelAlign: 'top',
                            ...
                            xtype: 'hiddenfield',
                            fieldLabel: climatestation.Utils.getTranslation('pixel_size_lat'),
                            labelAlign: 'top',
