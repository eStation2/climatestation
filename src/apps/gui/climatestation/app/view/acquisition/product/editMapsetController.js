Ext.define('climatestation.view.acquisition.product.editMapsetController', {
            ...
            if (Ext.data.StoreManager.lookup('mapsets').getUpdatedRecords() !== []){
                Ext.data.StoreManager.lookup('mapsets').sync({
                    success: function () {
                        ...
                        if (!me.params.edit) {
                            me.params.edit = true;
                            Ext.toast({html: climatestation.Utils.getTranslation('mapsetcreated'), title: climatestation.Utils.getTranslation('saved'), width: 200, align: 't'});
                    ...
                    failure: function () {
                        // console.log('failure');
                        if (!me.params.edit) {
                            Ext.toast({html: climatestation.Utils.getTranslation('errorcreatingmapset'), title: climatestation.Utils.getTranslation('error'), width: 200, align: 't'});
                        }
                        else {
                            Ext.toast({html: climatestation.Utils.getTranslation('errorupdatingmapset'), title: climatestation.Utils.getTranslation('error'), width: 200, align: 't'});
                        }
                    },
                    callback: function () {
