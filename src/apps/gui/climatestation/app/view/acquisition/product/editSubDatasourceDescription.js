...
Ext.define("climatestation.view.acquisition.product.editSubDatasourceDescription",{
    ...
    requires: [
        ...
        'climatestation.model.ScaleType',
        'climatestation.store.DataTypesStore',
        'climatestation.store.MapsetsStore',
        'climatestation.view.acquisition.product.editSubDatasourceDescriptionController',
        'climatestation.view.acquisition.product.editSubDatasourceDescriptionModel'
    ],
    ...
    initComponent: function () {
        ...
        if (me.params.edit){
            ...
            me.setTitle('<span class="panel-title-style">' + climatestation.Utils.getTranslation('newsubdatasourcedescr') + '</span>');
        }
        ...
        me.items = [{
            ...
            items: [{
                xtype: 'fieldset',
                title: '<div class="grid-header-style">' + climatestation.Utils.getTranslation('subdatasourcedescriptiondefinition') + '</div>',  // '<b>Ingested Sub Product definition</b>',
                ...
                items: [{
                    ...
                    items: [{
                        xtype: 'displayfield',
                        fieldLabel: climatestation.Utils.getTranslation('datasource'),
                        labelAlign: 'top',
                        ...
                        xtype: 'displayfield',
                        fieldLabel: climatestation.Utils.getTranslation('subproductcode'),
                        labelAlign: 'top',
                        reference: 'provider',
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            fieldLabel: climatestation.Utils.getTranslation('scale_type'),    // 'Frequency',
                            width: 145 + labelwidth,
                            allowBlank: false,
                            ...
                            typeAhead: false,
                            queryMode: 'local',
                            emptyText: climatestation.Utils.getTranslation('selectascaletype')    // 'Select a scale type...'
                        }, {
                            xtype: 'numberfield',
                        ...
                        items: [{
                            ...
                            fieldLabel: climatestation.Utils.getTranslation('re_process'),    // 'Re-process',
                            width: 100 + labelwidth,
                            allowBlank: true,
                            ...
                            fieldLabel: climatestation.Utils.getTranslation('re_extract'),    // 'Re-extract',
                            width: 100 + labelwidth,
                            allowBlank: true,
