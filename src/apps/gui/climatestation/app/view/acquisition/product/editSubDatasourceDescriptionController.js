Ext.define('climatestation.view.acquisition.product.editSubDatasourceDescriptionController', {
        ...
        Ext.Ajax.request({
            ...
            success: function(response, opts){
                ...
                if (result.success){
                    ...
                    if (!me.params.edit){
                        me.params.edit = true;
                        Ext.toast({ html: climatestation.Utils.getTranslation('subdatasourcedescrcreated'), title: climatestation.Utils.getTranslation('subdatasourcedescrcreated'), width: 200, align: 't' });
