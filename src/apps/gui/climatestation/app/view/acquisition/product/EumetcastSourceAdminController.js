Ext.define('climatestation.view.acquisition.product.EumetcastSourceAdminController', {
    ...
    onAddEumetcastSourceClick: function() {
        ...
        var newEumetcastSourceRecord = new climatestation.model.EumetcastSource({
    ...
    onRemoveEumetcastSourceClick: function(grid, rowIndex, row) {
        ...
        var messageText = climatestation.Utils.getTranslation('delete_eumetcastsource-question') + ': <BR>' +
    ...
    //         viewModel: {
    //             data: {
    //                 title: record ? climatestation.Utils.getTranslation('edit') + ': ' + record.get('collection_name') : climatestation.Utils.getTranslation('addeumetcastsource')  // 'Add Eumetcast Source'
    //             },
    ...
    //                     reference: 'climatestation.model.EumetcastSource',
    //                     create: true
    //                 }
    //             }
    //         }
