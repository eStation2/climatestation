Ext.define('climatestation.store.IngestSubProductsStore', {
    extend  : 'Ext.data.Store',
    alias: 'store.ingestsubproducts',

    model: 'climatestation.model.IngestSubProduct',
    ...
    ,listeners: {
        write: function(store, operation){
            ...
            //             title: climatestation.Utils.getTranslation('ingestproductupdated'),  // "Ingest product updated",
            //             width: 300, align: 't' });
        }
    }
