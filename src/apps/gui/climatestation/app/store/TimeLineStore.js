Ext.define('climatestation.store.TimeLineStore', {
    ...
    requires: [
        ...
        'climatestation.model.TimeLine'
    ],

    model: 'climatestation.model.TimeLine',
...
//climatestation.store.TimeLineStore.loadData(data);