Ext.define('climatestation.store.ProcessingStore', {
    extend  : 'Ext.data.Store',
    alias: 'store.processing',

    model: 'climatestation.model.Processing',

    requires: [
        'Ext.data.proxy.Rest',
        'climatestation.Utils',
        'climatestation.model.Processing'
    ],
    ...
    ,listeners: {
        write: function(store, operation){
            Ext.toast({ html: operation.getResultSet().message,
                        title: climatestation.Utils.getTranslation('processingchainupdated'),  // "Processing chain updated",  "Cha�ne de traitement mise � jour"
                        width: 300, align: 't' });
        }
    }
